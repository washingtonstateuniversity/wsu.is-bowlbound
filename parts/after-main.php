...
<section class="footer-hero">
	...
	<svg id="footer-hero"
		...
		<image xlink:href="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/footer-hero-overlay.jpg' ); ?>" x="-22.41" y="0" width="101.74" height="100" mask="url(#footer-hero--mask-overlay)"/>

		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 190 146" x="14.27" y="18.6" width="32.86" height="25.21">
			<g fill="#a60f2d">
		...
		<rect fill="#a60f2d" x="-3.15" y="43.6" width="50.25" height="1.74"/>
		...
		<rect fill="#4c4c4c" x="-87.4" y="75.4" width="101.56" height="1.74"/>

		<image xlink:href="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/footer-hero-bg.jpg' ); ?>" x="-22.41" y="0" width="210.43" height="100" mask="url(#footer-hero--mask-background)"/>

		<image xlink:href="<?php echo esc_url( get_stylesheet_directory_uri() . '/images/footer-hero-bg-color.jpg' ); ?>" x="-22.41" y="0" width="210.43" height="100" mask="url(#footer-hero--mask-background)"/>
